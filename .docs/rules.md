...
[Part 00](../../.docs/PART_00_SYSTEM_UNIFICATION_SPECIFICATION.md) is the source
...
- [Part 01 — UI/UX](../../.docs/PART_01_INTERFACE_AND_INTERACTION_UNIFICATION.md);
- [Part 02 — observability](../../.docs/PART_02_OBSERVABILITY_AUDIT_AND_LOG_EXPORT.md);
- [Part 03 — backup and recovery](../../.docs/PART_03_BACKUP_AND_RECOVERY.md);
- [Part 04 — bootstrap and deployment](../../.docs/PART_04_BOOTSTRAP_AND_DEPLOYMENT.md);
- [Part 05 — CI, releases and updates](../../.docs/PART_05_CI_RELEASES_AND_LOCAL_UPDATES.md);
- [Part 06 — pre-push acceptance](../../.docs/PART_06_UNIFIED_ACCEPTANCE_CHECKLIST.md);
- [Part 07 — security and exposure](../../.docs/PART_07_SECURITY_AND_EXPOSURE_CONTROL.md);
- [Part 09 — shared-agent lifecycle](../../.docs/PART_09_SERVICE_AGENTS_DEPLOYMENT_AND_LIFECYCLE.md);
- [Part 10 — shared-agent UI](../../.docs/PART_10_SERVICE_AGENTS_UI_AND_OPERATOR_WORKFLOWS.md).
...
- Release instructions must remain consistent with
  [Part 05](../../.docs/PART_05_CI_RELEASES_AND_LOCAL_UPDATES.md).
